...
(let* ((bg "#131313")
      ...
      (success "#b9cda0")
      (on-success "#253515")
      (success-container "#3b4c29")
      (on-success-container "#d5eaba")
      ;; Map fixed colors to regular colors
      (primary-fixed "#ffb956")
      (primary-fixed-dim "#633f00")
      (secondary-fixed "#dec2a2")
      (secondary-fixed-dim "#57432b")
      (tertiary-fixed "#b9cda0")
      (tertiary-fixed-dim "#3b4c29")
      (on-primary-fixed "#452b00")
      (on-primary-fixed-variant "#ffddb5")
      (on-secondary-fixed "#3e2d16")
      (on-secondary-fixed-variant "#fbdebc")
      (on-tertiary-fixed "#253515")
      (on-tertiary-fixed-variant "#d5eaba")
