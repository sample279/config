...
(let* ((bg "#291d14")
      (err "#9a5a2a")
      (err-container "#42220b")
      (on-background "#f3f2f2")
      (on-err "#f2e9e0")
      (on-err-container "#f4e3d7")
      (on-primary "#251e18")
      (on-primary-container "#f4e3d7")
      (on-secondary "#251e18")
      (on-secondary-container "#f4f2d7")
      (on-surface "#f3f2f2")
      (on-surface-variant "#b6b2af")
      (on-tertiary "#251e18")
      (on-tertiary-container "#e8f4d7")
      (outline-color "#716861")
      (outline-variant "#73685e")
      (primary "#e49d67")
      (primary-container "#8d430c")
      (secondary "#d6cd5c")
      (secondary-container "#6f6810")
      (shadow "#291d14")
      (surface "#291d14")
      (surface-container "#453021")
      (surface-container-high "#3e2c1e")
      (surface-container-highest "#4c3525")
      (surface-container-low "#221811")
      (surface-container-lowest "#150f0a")
      (surface-variant "#37271b")
      (tertiary "#a1d35f")
      (tertiary-container "#466e12")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#a1d35f")
      (on-success "#251e18")
      (success-container "#466e12")
      (on-success-container "#e8f4d7")
      ;; Map fixed colors to regular colors
      (primary-fixed "#e49d67")
      (primary-fixed-dim "#8d430c")
      (secondary-fixed "#d6cd5c")
      (secondary-fixed-dim "#6f6810")
      (tertiary-fixed "#a1d35f")
      (tertiary-fixed-dim "#466e12")
      (on-primary-fixed "#251e18")
      (on-primary-fixed-variant "#f4e3d7")
      (on-secondary-fixed "#251e18")
      (on-secondary-fixed-variant "#f4f2d7")
      (on-tertiary-fixed "#251e18")
      (on-tertiary-fixed-variant "#e8f4d7")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f3f2f2")
      (inverse-primary "#e49d67")
      (inverse-surface "#291d14")
