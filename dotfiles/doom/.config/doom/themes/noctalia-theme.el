...
(let* ((bg "#222222")
      (err "#b36d43")
      (err-container "#3d200f")
      (on-background "#c2c2b0")
      (on-err "#222222")
      (on-err-container "#f1e3da")
      (on-primary "#222222")
      (on-primary-container "#f3ebd8")
      (on-secondary "#222222")
      (on-secondary-container "#f1e3da")
      (on-surface "#c2c2b0")
      (on-surface-variant "#c9a554")
      (on-tertiary "#222222")
      (on-tertiary-container "#f1e4da")
      (outline-color "#6c6c6c")
      (outline-variant "#464646")
      (primary "#c9a554")
      (primary-container "#594312")
      (secondary "#b36d43")
      (secondary-container "#3d200f")
      (shadow "#1a1a1a")
      (surface "#222222")
      (surface-container "#2a2a2a")
      (surface-container-high "#343434")
      (surface-container-highest "#3e3e3e")
      (surface-container-low "#262626")
      (surface-container-lowest "#232323")
      (surface-variant "#2a2a2a")
      (tertiary "#bb7744")
      (tertiary-container "#3e230f")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#bb7744")
      (on-success "#222222")
      (success-container "#3e230f")
      (on-success-container "#f1e4da")
      ;; Map fixed colors to regular colors
      (primary-fixed "#c9a554")
      (primary-fixed-dim "#594312")
      (secondary-fixed "#b36d43")
      (secondary-fixed-dim "#3d200f")
      (tertiary-fixed "#bb7744")
      (tertiary-fixed-dim "#3e230f")
      (on-primary-fixed "#222222")
      (on-primary-fixed-variant "#f3ebd8")
      (on-secondary-fixed "#222222")
      (on-secondary-fixed-variant "#f1e3da")
      (on-tertiary-fixed "#222222")
      (on-tertiary-fixed-variant "#f1e4da")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#c2c2b0")
      (inverse-primary "#c9a554")
